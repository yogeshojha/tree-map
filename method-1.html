...
<div class='grid fill-light'>
  <div class='col12 pad4 center fill-blue dark'>
	...
	<h4 class='fancy'>An initiative by <a href="http://www.gubbilabs.in" target="_blank">Gubbi Labs</a>.</h4>
  </div>
  <div class='col12 clearfix'>
    ...
    <div id="welcome" class='col9 pad4 fill-white prose'>
	...
	<h3>STEPS:</h3>
	<ol>
	<li>One can use two key base maps: OSM Streets or Mapbox Satellite. Open the link on the browser of your phone/laptop. <a href='map-streets.html' target="_blank" class='icon marker button'>Map using OSM Streets</a>
      <a href='map-satellite.html' target="_blank" class='icon marker button'>Map using Mapbox Satellite</a></li>
